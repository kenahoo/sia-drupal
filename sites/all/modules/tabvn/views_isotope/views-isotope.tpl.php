...
<div id="portfolio-wrapper">
  <div class="row" id="isotope-container">
    ...
    <?php foreach ($rows as $id => $row): ?>
      ...
      ?>
      <div class="<?php print $portfolio_style; ?> portfolio-item-wrapper isotope-element isotope-element-<?php print $count; ?> <?php print $classlist; ?>" data-category="<?php print $classlist; ?>" <?php print $bgstyle ?>>
