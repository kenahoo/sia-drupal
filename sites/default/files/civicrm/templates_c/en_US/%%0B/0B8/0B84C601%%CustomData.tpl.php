...
" class="crm-accordion-wrapper crm-accordion_title-accordion <?php if ($this->_tpl_vars['cd_edit']['collapse_display'] && ! $this->_tpl_vars['skipTitle']): ?>crm-accordion-closed<?php else: ?>crm-accordion-open<?php endif; ?>">
