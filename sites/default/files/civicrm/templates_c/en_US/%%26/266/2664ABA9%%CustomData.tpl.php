...
?>    
	<div class="crm-accordion-wrapper crm-address-accordion <?php if ($this->_tpl_vars['cd_edit']['collapse_display']): ?>crm-accordion-closed<?php else: ?>crm-accordion-open<?php endif; ?>">
		<div class="crm-accordion-header">
			<div id="custom<?php echo $this->_tpl_vars['group_id']; ?>
" class="icon crm-accordion-pointer"></div>

        <a href="#" class="whiteanchor"><?php echo $this->_tpl_vars['cd_edit']['title']; ?>
</a>
