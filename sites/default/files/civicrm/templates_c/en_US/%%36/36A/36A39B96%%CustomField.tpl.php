...
smarty_core_load_plugins(array('plugins' => array(array('function', 'help', 'CRM/Custom/Form/CustomField.tpl', 39, false),array('block', 'ts', 'CRM/Custom/Form/CustomField.tpl', 61, false),array('modifier', 'strip_tags', 'CRM/Custom/Form/CustomField.tpl', 61, false),)), $this); ?>
<?php $this->assign('element_name', $this->_tpl_vars['element']['element_name']); ?>
<?php if ($this->_tpl_vars['element']['help_post']): ?>
    <?php $this->assign('help_post', $this->_tpl_vars['element']['help_post']); ?>
<?php endif; ?>
...
<?php if ($this->_tpl_vars['element']['help_post']): ?><?php echo smarty_function_help(array('id' => $this->_tpl_vars['element_name'],'text' => $this->_tpl_vars['help_post']), $this);?>
<?php endif; ?></td>
                    ...
                    <?php if ($this->_tpl_vars['element']['element_value']['data']): ?>
                        <span class="html-adjust"><br />
                            ...
                            <?php if ($this->_tpl_vars['element']['element_value']['displayURL']): ?>
                                <a href="javascript:popUp('<?php echo $this->_tpl_vars['element']['element_value']['imageURL']; ?>
