...
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/common/SocialNetwork.tpl', 29, false),array('modifier', 'escape', 'CRM/common/SocialNetwork.tpl', 56, false),)), $this); ?>
...
"><?php echo $this->_tpl_vars['title']; ?>
    ...
    <div class="crm-fb-tweet-buttons">
        <?php if ($this->_tpl_vars['emailMode'] == true): ?>
                        <a href="//twitter.com/share?url=<?php echo $this->_tpl_vars['url']; ?>
&amp;text=<?php echo $this->_tpl_vars['title']; ?>
" id="crm_tweet">
                <img title="Twitter Tweet Button" src="<?php echo $this->_tpl_vars['config']->userFrameworkResourceURL; ?>
/i/tweet.png" width="55px" height="20px"  alt="Tweet Button">
            </a>
            <a href="//www.facebook.com/plugins/like.php?href=<?php echo $this->_tpl_vars['url']; ?>
" target="_blank">
                <img title="Facebook Like Button" src="<?php echo $this->_tpl_vars['config']->userFrameworkResourceURL; ?>
/i/fblike.png" alt="Facebook Button" />
            </a>
        <?php else: ?>
                        <div class="label">
                <iframe allowtransparency="true" frameborder="0" scrolling="no"
                src="//platform.twitter.com/widgets/tweet_button.html?text=<?php echo $this->_tpl_vars['title']; ?>
...
></g:plusone>
            ...
            <div class="label" style="width:300px;">
                <iframe src="//www.facebook.com/plugins/like.php?app_id=240719639306341&amp;href=<?php echo ((is_array($_tmp=$this->_tpl_vars['url'])) ? $this->_run_mod_handler('escape', true, $_tmp, 'url') : smarty_modifier_escape($_tmp, 'url')); ?>
