...
smarty_core_load_plugins(array('plugins' => array(array('block', 'ts', 'CRM/Contact/Form/Edit/Phone.tpl', 32, false),array('modifier', 'crmReplace', 'CRM/Contact/Form/Edit/Phone.tpl', 41, false),)), $this); ?>
...
&nbsp;&nbsp;<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>ext.<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>&nbsp;<?php echo ((is_array($_tmp=$this->_tpl_vars['form']['phone'][$this->_tpl_vars['blockId']]['phone_ext']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'four') : smarty_modifier_crmReplace($_tmp, 'class', 'four')); ?>
&nbsp;</td>
