...
<?php echo '";
var activityUrl = "'; ?>
<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/view','q' => "action=browse&selectedChild=activity&reset=1&cid=changeid&context=".($this->_tpl_vars['context']),'h' => 0), $this);?>
<?php echo '";
var emailUrl    = "'; ?>
<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/view/activity','q' => "atype=3&action=add&reset=1&cid=changeid&context=".($this->_tpl_vars['context']),'h' => 0), $this);?>
<?php echo '";
var contactUrl  = "'; ?>
<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/changeaction','q' => "reset=1&cid=changeid&key=".($this->_tpl_vars['qfKey'])."&context=".($this->_tpl_vars['context']),'h' => 0), $this);?>
<?php echo '";
var tagUrl  = "'; ?>
<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/contact/view','q' => "selectedChild=tag&reset=1&cid=changeid&key=".($this->_tpl_vars['qfKey']),'h' => 0), $this);?>
<?php echo '";
...
<?php echo '";
        ...
        if ( action == \'add\' || action == \'view\') {
            ...
            var destination = "'; ?>
<?php echo CRM_Utils_System::crmURL(array('q' => "qfKey=".($this->_tpl_vars['qfKey']),'h' => 0), $this);?>
<?php echo '";
...
?><?php echo '
   	cj("#mark_x_'; ?>
<?php echo $this->_tpl_vars['selectedContactId']; ?>
<?php echo '").attr(\'checked\', \'checked\');
  '; ?>
 
  <?php endforeach; endif; unset($_from); ?>
    
  <?php $_from = $this->_tpl_vars['unselectedContactIds']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['unselectedContactId']):
?><?php echo '
        cj("#mark_x_'; ?>
<?php echo $this->_tpl_vars['unselectedContactId']; ?>
<?php echo '").removeAttr(\'checked\');'; ?>
...
function countSelections( ){
  var Url =  "'; ?>
<?php echo CRM_Utils_System::crmURL(array('p' => 'civicrm/ajax/markSelection','h' => 0), $this);?>
<?php echo '";	
  var key =  \'civicrm search '; ?>
<?php echo $this->_tpl_vars['qfKey']; ?>
<?php echo '\';
