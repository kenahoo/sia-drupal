...
<div id="commPrefs" class="crm-accordion-body">
    <table class="form-layout-compressed" >
        ...
        <tr>
            <?php if (! empty ( $this->_tpl_vars['form']['email_greeting_id'] )): ?>
                <td>
                    <span id="email_greeting" <?php if (! empty ( $this->_tpl_vars['email_greeting_display'] ) && $this->_tpl_vars['action'] == 2): ?> class="hiddenElement"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['email_greeting_id']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'big') : smarty_modifier_crmReplace($_tmp, 'class', 'big')); ?>
</span>
...
i/edit.png" border="0" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Edit<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"></a></div>
            ...
            <?php if (! empty ( $this->_tpl_vars['form']['postal_greeting_id'] )): ?>
                <td>
                    <span id="postal_greeting" <?php if (! empty ( $this->_tpl_vars['postal_greeting_display'] ) && $this->_tpl_vars['action'] == 2): ?> class="hiddenElement"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['postal_greeting_id']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'big') : smarty_modifier_crmReplace($_tmp, 'class', 'big')); ?>
</span>
...
i/edit.png" border="0" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Edit<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"></a></div>
            ...
            <?php if (! empty ( $this->_tpl_vars['form']['addressee_id'] )): ?>
                <td>
                    <span id="addressee" <?php if (! empty ( $this->_tpl_vars['addressee_display'] ) && $this->_tpl_vars['action'] == 2): ?> class="hiddenElement"<?php endif; ?>><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['addressee_id']['html'])) ? $this->_run_mod_handler('crmReplace', true, $_tmp, 'class', 'big') : smarty_modifier_crmReplace($_tmp, 'class', 'big')); ?>
</span>
