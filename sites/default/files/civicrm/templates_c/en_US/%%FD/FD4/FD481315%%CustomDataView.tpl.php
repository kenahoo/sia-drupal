...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'CRM/Custom/Page/CustomDataView.tpl', 31, false),array('modifier', 'crmMoney', 'CRM/Custom/Page/CustomDataView.tpl', 82, false),array('function', 'crmURL', 'CRM/Custom/Page/CustomDataView.tpl', 35, false),array('function', 'crmKey', 'CRM/Custom/Page/CustomDataView.tpl', 132, false),array('block', 'ts', 'CRM/Custom/Page/CustomDataView.tpl', 35, false),)), $this); ?>
...
" class="section-shown form-item">
        <div class="crm-accordion-wrapper crm-accordion_title-accordion <?php if ($this->_tpl_vars['cd_edit']['collapse_display'] == 0 || $this->_tpl_vars['skipTitle']): ?>crm-accordion-open<?php else: ?>crm-accordion-closed<?php endif; ?>">
            ...
            <?php else: ?>
              ...
              <?php if ($this->_tpl_vars['element']['field_type'] == 'File'): ?>
                <?php if ($this->_tpl_vars['element']['field_value']['displayURL']): ?>
                  <td class="html-adjust"><a href="javascript:imagePopUp('<?php echo $this->_tpl_vars['element']['field_value']['imageURL']; ?>
                ...
                <?php else: ?>
                  <td class="html-adjust">
                    <?php if ($this->_tpl_vars['element']['contact_ref_id']): ?>
                      <a href='/civicrm/contact/view?reset=1&cid=<?php echo $this->_tpl_vars['element']['contact_ref_id']; ?>
'>
                  <?php endif; ?>
