...
define('TZN_DB_HOST','mysql.singersinaccord.org');
define('TZN_DB_USER','kenahoo');    // edit here
define('TZN_DB_PASS','***REMOVED***');     // edit here
define('TZN_DB_BASE','singersinaccord_taskfreak');  // edit here
...
define('FRK_DEFAULT_CONTEXT_LONG',TRUE);	// TRUE or FALSE
